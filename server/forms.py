...
class PrescriptionForm(BasicForm):
    ...
    setup_field(date)
    druglist    = forms.ModelChoiceField(queryset=Account.objects.filter(role=Account.ACCOUNT_PATIENT)) #forms.CharField(max_length=50)              # by sam 20200221 to add smart drug list 
